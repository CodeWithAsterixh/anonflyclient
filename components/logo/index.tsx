      ...
      >
        <defs>
          <linearGradient id="logo-shield-grad" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <stop offset="100%" stopColor="var(--primary-color, #1d4ed8)" />
          </linearGradient>
        </defs>
        ...
        <path d="M128 200L32 280L128 320" fill="var(--primary-color, #3b82f6)" fillOpacity="0.6" />
        <path d="M384 200L480 280L384 320" fill="var(--primary-color, #3b82f6)" fillOpacity="0.6" />
      </svg>
      {showText && (
