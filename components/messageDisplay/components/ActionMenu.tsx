...
export const ActionMenu: React.FC<ActionMenuProps> = ({
  ...
  <div className="bg-background/95 backdrop-blur-md border border-border rounded-2xl p-1 shadow-2xl min-w-[200px] animate-in slide-in-from-top-2 duration-300">
    <button
      ...
      className="w-full flex items-center gap-3 px-4 py-3 hover:bg-white/5 transition-colors text-foreground rounded-xl"
    >
    ...
    {isEditable && (
      <>
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-4 py-3 hover:bg-white/5 transition-colors text-primary rounded-xl"
        >
